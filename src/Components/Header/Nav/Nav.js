    ...
    <Fragment>
      <div className="container-Nav">
        <div className="head-nav">
          ...
          <div className="sl-nav-head" onClick={()=>setIsShowOptions(!isShowOptions)}>
            <span className="sl-nav">Chọn</span>
            <i class="fa-solid fa-caret-down"></i>
          </div>
          <div className={`op-nav-head ${isShowOptions === true ? "op-nav-head-active" : ""}`}>
        ...
        <div className="body-nav">
          ...
          <input type="text" placeholder="Search..." className="input-nav" onChange={searchList}/>
        </div>
