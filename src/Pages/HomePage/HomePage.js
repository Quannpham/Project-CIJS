...
const HomePage = () => {
  ...
  useEffect(()=>{
    let i = 0;
    const images = Array.from(Array(20), () => {
      ...
      const imgUrl = `https://firebasestorage.googleapis.com/v0/b/project-cijs-85.appspot.com/o/a-r1.png?alt=media&token=b0bc460d-c461-4a98-b575-c7212f10e443`;
